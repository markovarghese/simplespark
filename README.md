...
```text
20/11/10 06:00:07 INFO confluent.SchemaManager: AvroSchemaUtils.registerIfCompatibleSchema: Registering schema for subject: za.co.absa.abris.avro.registry.SchemaSubject@4bc9389
Exception in thread "main" java.lang.NoSuchFieldError: FACTORY
        ...
        at za.co.absa.abris.avro.read.confluent.SchemaManager$$anonfun$getIfExistsOrElseRegisterSchema$1.apply$mcI$sp(SchemaManager.scala:124)
        at za.co.absa.abris.avro.read.confluent.SchemaManager$$anonfun$getIfExistsOrElseRegisterSchema$1.apply(SchemaManager.scala:124)
        at za.co.absa.abris.avro.read.confluent.SchemaManager$$anonfun$getIfExistsOrElseRegisterSchema$1.apply(SchemaManager.scala:124)
...
You can work around this error, by creating the topic `test123` manually using the Confluent Control Center, and setting the topic's value schema to 
```json
...
This time, it works with no errors.

#### Maven Dependency Tree
If you run 
```shell script
docker run -e MAVEN_OPTS="-Xmx1024M -Xss128M -XX:MetaspaceSize=512M -XX:MaxMetaspaceSize=1024M -XX:+CMSClassUnloadingEnabled" --rm -v "${PWD}":/usr/src/mymaven -v "${HOME}/.m2":/root/.m2 -w /usr/src/mymaven maven:3.6.3-jdk-8 mvn dependency:tree
```
...
[INFO] \- org.apache.spark:spark-sql_2.11:jar:2.4.6:provided
[INFO]    +- com.univocity:univocity-parsers:jar:2.7.3:provided
[INFO]    +- org.apache.spark:spark-sketch_2.11:jar:2.4.6:provided
[INFO]    +- org.apache.spark:spark-core_2.11:jar:2.4.6:provided
...
[INFO]    |  +- org.apache.spark:spark-launcher_2.11:jar:2.4.6:provided
[INFO]    |  +- org.apache.spark:spark-kvstore_2.11:jar:2.4.6:provided
[INFO]    |  |  \- org.fusesource.leveldbjni:leveldbjni-all:jar:1.8:provided
[INFO]    |  +- org.apache.spark:spark-network-common_2.11:jar:2.4.6:provided
[INFO]    |  +- org.apache.spark:spark-network-shuffle_2.11:jar:2.4.6:provided
[INFO]    |  +- org.apache.spark:spark-unsafe_2.11:jar:2.4.6:provided
...
[INFO]    |  |     \- org.scala-lang.modules:scala-xml_2.11:jar:1.0.6:provided
...
[INFO]    +- org.apache.spark:spark-catalyst_2.11:jar:2.4.6:provided
[INFO]    |  +- org.scala-lang:scala-reflect:jar:2.11.12:provided
[INFO]    |  +- org.scala-lang.modules:scala-parser-combinators_2.11:jar:1.1.0:provided
...
[INFO]    +- org.apache.spark:spark-tags_2.11:jar:2.4.6:compile
